   ...
   <body>
       ...
       <div id='blogBody' class='pageBody'>
           <div class="recipesDiv">
               <div class="recipeContainer" v-for="post in posts" v-on:click="displayRecipeText">
                   <h2 class="recipeTitle" v-html="post.title"></h2>
                   <div class="recipeContentDiv" v-html="post.content">
                       <div class="closeRecipeButton"></div>
                   </div>
               </div>
           </div>
