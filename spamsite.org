   ...
   <body>
       ...
       <div id='blogBody' class='pageBody'>
           ...
           <div class="recipesDiv">
               <div class="recipeContainer" v-for="post in posts" v-on:click="displayRecipeText" v-bind:id="'id'+post.id">
                   <h2 class="recipeTitle" v-html="post.title" v-bind:id="'id'+post.id"></h2>
               </div>
           </div>
